                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            <li>
                                ...
                                <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                    <li class="w-100">
                                        <a href="{{url('admin/projects') }}" class="nav-link px-0 link-light"> <span class="d-none d-sm-inline">{{ __('Admin Projects') }}</span></a>
                                    </li>
                                    <li>
                                        <a href="#" class="nav-link px-0 link-light"> <span class="d-none d-sm-inline">Item</span>2</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                                    <li class="w-100">
                                        <a href="#" class="nav-link px-0 link-light"> <span class="d-none d-sm-inline">Item</span>
                                            1</a>
                                    </li>
                                    <li>
                                        <a href="#" class="nav-link px-0 link-light"> <span class="d-none d-sm-inline">Item</span>
                            ...
                            <li>
                                <a href="#submenu3" data-bs-toggle="collapse" class="nav-link px-0 align-middle link-light">
                                    <i class="fs-4 bi-grid"></i> <span class="ms-1 d-none d-sm-inline">Products</span>
                                </a>
                                <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                                    <li class="w-100">
                                        <a href="#" class="nav-link px-0 link-light"> <span
